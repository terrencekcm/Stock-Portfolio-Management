...
def parse_dates():
    parser = argparse.ArgumentParser(description="Russell 2000 Market Breadth Analyzer")
...
def get_russell2000_tickers():
    filepath = os.path.join('data', 'russell2000.csv')
...
def run_python2_smallcap(start_date, end_date):
    ...
    print(f"Russell 2000當期漲跌幅: {rut_str}")
    print("--------------------------------------------------")
...
if __name__ == '__main__':
    ...
    run_python2_smallcap(s_date, e_date)
